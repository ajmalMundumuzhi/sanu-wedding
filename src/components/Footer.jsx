    ...
    return(
        <section className="flex flex-col justify-center items-center">
            <div className="text-center">
                ...
                <hr />
                <p className="text-sm md:text-2xl  font-medium m-6 md:mb-10">Designed By <a href="https://www.linkedin.com/in/ajmalmundumuzhi/" className="decoration-none">Mohammed Ajmal</a> </p>
            </div>
        </section>
    )
}